...
<html-embed id="realm-atlas" src="./embeds/realm-atlas/index.html" title="飞星大陆：点选境界原文" height="620">
境界列表照录原设定，包括第7项问仙；图形不增加数值或修炼规则。
</html-embed>

<text-mark tone="thesis" effect="fluorescent">修炼本质提升的是血量，伤害吸收和抗性</text-mark>
...
7\.问仙：追寻仙道，从此境界开始，<text-mark tone="thesis" effect="fluorescent">修炼不在凭借普通修为，而是凭借顿悟</text-mark>
